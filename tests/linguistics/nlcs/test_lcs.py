...
class BasicTestSuite(unittest.TestCase):
    ...
    def test_two_strings1(self):
        ...
        self.assertEqual(lcs_obj.lcs("how do you write tests?", "Writing is an essential part of coding"), "writ")

    def test_two_strings2(self):
        lcs_obj = floodtags.linguistics.nlcs.lcs.LongestCommonString()
        self.assertEqual(lcs_obj.lcs("piilosana", "namiloma"), "ilo")
    ...
    def test_n_strings1(self):
        ...
        self.assertEqual(lcs_obj.lcs(list), "the north")
    ...
    def test_n_strings2(self):
        ...
        self.assertEqual(lcs_obj.lcs(list), " short sub")

    def test_no_substring1(self):
        lcs_obj = floodtags.linguistics.nlcs.lcs.LongestCommonString()
        list = ["bejdeodeobej", "lpokollpokpl", "qwuvmwqqw"]
        self.assertEqual(lcs_obj.lcs(list), "")
    ...
    def test_same_string(self):
        ...
        self.assertEqual(lcs_obj.lcs(list), "mirror's edge")
